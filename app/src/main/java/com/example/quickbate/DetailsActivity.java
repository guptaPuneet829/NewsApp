...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_published = findViewById(R.id.textPublishedDetail);
        text_source = findViewById(R.id.textSrcDetail);
        text_title = findViewById(R.id.textTtlDetail);
        img_news = findViewById(R.id.imgNewsDetail);
